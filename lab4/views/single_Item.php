...
<body>
    <div class="container">
        <?php $item=get_items("items",$item_id)[0]; ?>
        <div class="card bg-light pd-2 col" style="width: 20rem; margin:50px auto;">
            <img src="<?php echo "assets/images/".$item["photo"]; ?>" class="card-img-top img-fluid" >
            <div class="card-body">
